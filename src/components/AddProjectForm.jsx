...
import API from '../api'; // ✅ Replaced axios for backend requests
import axios from 'axios'; // ✅ Kept for Cloudinary only
...
function AddProjectForm({ onProjectAdded }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await API.post('/api/projects', formData); // ✅ Uses dynamic base URL
